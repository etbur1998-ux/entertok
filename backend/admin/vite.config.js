...
export default defineConfig({
  ...
  server: {
    ...
    proxy: {
      ...
      '/uploads': { target: 'http://127.0.0.1:8082', changeOrigin: true },
      '/health':  { target: 'http://127.0.0.1:8082', changeOrigin: true },
      '/debug':   { target: 'http://127.0.0.1:8082', changeOrigin: true },
      '/ws':      { target: 'http://127.0.0.1:8082', changeOrigin: true, ws: true },
    }
  },
  build: {
